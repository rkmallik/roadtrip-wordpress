...
* Try a different version of phpFlickr (the module that communicates with Flickr to get the photos). To do that download and substitute the files into the folder “phpFlickr”.
	* phpFlickr 3.1.1: download from [Github](https://github.com/miromannino/phpflickr/releases/tag/phpFlickr3.1.1)
	* nextend version: download from [Github](https://github.com/miromannino/phpflickr/releases/tag/FlickrPhotostream3.1.5). Currently used in Flickr Photostream 3.1.5
